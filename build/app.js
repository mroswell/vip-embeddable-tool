...
function program5(depth0,data) {
  ...
  buffer += "\n  <span>\n    <a href=\"#\" target=\"_blank\">\n      <img src=\"./images/directions.png\">\n    </a>\n  </span>\n</div>\n<div id=\"map-canvas\" class=\"right\"></div>\n\n<div class=\"info box left\" id=\"resources-toggle\">\n  "
    ...
    + escapeExpression(((stack1 = ((stack1 = ((stack1 = (depth0 && depth0.assets)),stack1 == null || stack1 === false ? stack1 : stack1.text)),stack1 == null || stack1 === false ? stack1 : stack1.resources)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
...
function program9(depth0,data) {
  ...
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n  ";
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.electionRegistrationConfirmationUrl), {hash:{},inverse:self.noop,fn:self.program(3, program3, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n  ";
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.absenteeVotingInfoUrl), {hash:{},inverse:self.noop,fn:self.program(5, program5, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n  ";
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.votingLocationFinderUrl), {hash:{},inverse:self.noop,fn:self.program(7, program7, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n  ";
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.ballotInfoUrl), {hash:{},inverse:self.noop,fn:self.program(9, program9, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n\n</div>";
  return buffer;
  });
...
module.exports = [
  {
    "Certified?":"Yes",
    "State":"AL",
    "Who must show identification to vote?":"All voters except military voters, overseas voters, those allowed by the Voting Accessibility for the Elderly and Handicapped Act to vote absentee, and any other voter who is allowed to vote absentee by federal law. ",
    "What forms of voter identification are acceptable?":"Acceptable IDs include -- but are not limited to -- valid state-issued driver's license or non-driver ID, valid U.S. Military ID, valid U.S. Passport, or a utility bill with the voter's name and voting address. ",
    "If a voter does not present proper identification, can s/he still vote a regular ballot?":"Yes. If the voter is positively identified by two election officials, s/he may vote a regular ballot. ",
    "Link":"http://www.sos.state.al.us/elections/VoterID.aspx"
  },
  {
    "Certified?":"Yes",
    "State":"AK",
    ...
    "Link":"http://www.elections.alaska.gov/vi_hv_vote_polls.php"
  },
  {
    "Certified?":"No",
    "State":"AZ",
    "Who must show identification to vote?":"All voters.",
    "What forms of voter identification are acceptable?":"A voter must present ID that fits within one of the following three categories: 1. One form of ID with the photograph, name and voting address of the voter; 2. Two forms of ID with the name and address of the voter, but not the photo; or 3. One form of ID with the name and photo of the voter plus one form of ID with the name and voting address of the voter. Acceptable IDs include -- but are not limited to -- a valid AZ driver's license or non-operating identification license; tribal enrollment card or valid government-issued ID.",
    "If a voter does not present proper identification, can s/he still vote a regular ballot?":"No.",
    "Link":"http://www.azsos.gov/election/Prop_200/poll_identification.htm"
  },
  {
    "Certified?":"No",
    "State":"AR",
    "Who must show identification to vote?":"ID will be *requested* of all voters. However, ID Is only *required* of first-time voters who did not register in person with a government official.",
    "What forms of voter identification are acceptable?":"Acceptable IDs include -- but are not limited to -- a current and valid photo ID or a copy of a current utility bill, bank statement or paycheck.",
    "If a voter does not present proper identification, can s/he still vote a regular ballot?":"Yes. If a voter is unable to provide identification, the election official shall indicate on the precinct voter registration list that the voter did not provide identification. Following each election, the county board of election commissioners may review the precinct voter registration lists and may provide the information of the voters not providing identification at the polls to the prosecuting attorney, who may investigate possible voter fraud.",
    "Link":"http://www.sos.arkansas.gov/elections/Pages/votingInArkansas.aspx"
  },
  {
    "Certified?":"Yes",
    "State":"CA",
    ...
    "Link":"http://www.sos.ca.gov/elections/new-voter/where-how-vote.htm"
  },
  {
    "Certified?":"Yes",
    "State":"CO",
  ...
  },
  {
    ...
    "Link":"http://www.ct.gov/sots/LIB/sots/ElectionServices/HAVA/HavaPDF/IDRequirements.pdf"
  },
  {
    "Certified?":"Yes",
    "State":"DC",
    ...
    "Link":"http://www.dcboee.org/faq/election_day.asp#6"
  },
  {
    "Certified?":"Yes",
    "State":"DE",
    ...
    "Link":"http://elections.delaware.gov/services/voter/pdfs/how_to_vote.pdf"
  },
  {
    "Certified?":"Yes",
    "State":"FL",
    "Who must show identification to vote?":"All voters.",
    "What forms of voter identification are acceptable?":"Voters must show a current and valid photo ID. If the photo ID does not have a signature, an additional ID with signature is required. Acceptable IDs include -- but are not limited to -- a FL driver's license; FL ID card issued by motor vehicles agency; U.S. passport; debit or credit card; Military ID; Student ID, Retirement Center ID, Neighborhood Association ID; or Public Assistance ID. ",
    "If a voter does not present proper identification, can s/he still vote a regular ballot?":"No. The provisional ballot will count if the signature on the provisional ballot envelope matches the signature on the voter registration application. The canvassing board will determine the validity of the ballot. The voter has a right to present additional written evidence supporting their right to vote to the Supervior of Elections by no later than 5:00 p.m. on the 2nd day following the election.",
    "Link":"http://election.dos.state.fl.us/voting/voting-info.shtml#voting"
  },
  {
    "Certified?":"Yes",
    "State":"GA",
    "Who must show identification to vote?":"All voters.",
    "What forms of voter identification are acceptable?":"Acceptable IDs include -- but are not limited to -- a GA driver's license, even if expired;\n a valid Government employee photo ID; a valid U.S. passport; a valid U.S. military photo ID; a valid tribal photo ID; or valid Voter ID card.",
    "If a voter does not present proper identification, can s/he still vote a regular ballot?":"No. If a voter does not have one of the acceptable forms of photo ID, a voter can vote a provisional ballot. ",
    "Link":"http://www.sos.ga.gov/Gaphotoid/"
  },
  {
    "Certified?":"No",
    "State":"HI",
  ...
  },
  {
    ...
    "Link":"http://www.idahovotes.gov/VoterGuide/2012_Voter_Guide_English.pdf"
  },
  {
    "Certified?":"No",
    "State":"IL",
    ...
    "Link":"http://www.elections.il.gov/Downloads/VotingInformation/PDF/Illinois_Voter_Information.pdf"
  },
  {
    "Certified?":"No",
    "State":"IN",
    "Who must show identification to vote?":"All voters except voters who vote in person at a licensed care facility where the voter resides. ",
    "What forms of voter identification are acceptable?":"Acceptable forms of ID must have 1. the voter's photo 2. the voter's name 3. display an expiration date and be current or have expired since the last general election and 4. be issued by the State of Indiana or the U.S. Government. Acceptable IDs include -- but are not limited to -- an IN driver's license, IN photo ID card, Military ID, U.S. Passport or a student ID from an Indiana State school.",
    ...
    "Link":"http://www.in.gov/sos/elections/2401.htm"
  },
  {
    "Certified?":"No",
    "State":"IA",
    ...
    "Link":"http://sos.iowa.gov/elections/voterinformation/edr.html"
  },
  {
    "Certified?":"Yes",
    "State":"KS",
    ...
    "Link":"http://www.gotvoterid.com/valid-photo-ids.html#idlist"
  },
  {
    "Certified?":"No",
    "State":"KY",
    ...
    "What forms of voter identification are acceptable?":"Acceptable documentation includes -- a motor vehicle operator's license, Social Security card, credit card, or another form of ID containing the voter's picture and signature. Or, the voter's identity may be confirmed by personal acquaintance.",
    "If a voter does not present proper identification, can s/he still vote a regular ballot?":"Yes. The voter's identity may be confirmed by personal acquaintance. If the voter does not have identification and cannot be identified by the precinct officer, s/he may vote a provisional ballot. ",
    "Link":"http://elect.ky.gov/voterinfo/Pages/voterinformationguide.aspx"
  },
  {
    "Certified?":"No",
    "State":"LA",
    ...
    "If a voter does not present proper identification, can s/he still vote a regular ballot?":"Yes. If the voter does not have the required photo ID, s/he may still vote if they present a utility bill, payroll check or government document that includes his/her name and address. The voter will have to sign an affidavit.",
    "Link":"http://www.sos.la.gov/tabid/151/Default.aspx"
  },
  {
    "Certified?":"No",
    "State":"ME",
    ...
    "What forms of voter identification are acceptable?":"Acceptable IDs include -- but are not limited to -- a current and valid U.S. passport, military ID, driver's license, state ID, or a utility bill, bank statement, or paycheck with the voter's name and voting address. ",
    ...
    "Link":"http://www.maine.gov/sos/cec/elec/voterguide.html"
  },
  {
    "Certified?":"Yes",
    "State":"MD",
    ...
    "Link":"http://www.elections.state.md.us/voting/election_day_questions.html"
  },
  {
    "Certified?":"No",
    "State":"MA",
    "Who must show identification to vote?":"An election officer may *randomly request* identification from any voter, as long as the request is truly random. Only first-time voters who did not register in person with a government official whose MA driver's license number or last four digits of Social Security number can't be verified by the state and voters who are marked as inactive *must* show ID.",
    "What forms of voter identification are acceptable?":"Acceptable forms of ID must be current and valid and have the voter's name and voting address. Acceptable IDs include -- but are not limited to -- a driver's license, current utility bill, bank statement, paycheck, or government check.",
    "If a voter does not present proper identification, can s/he still vote a regular ballot?":"No.",
    "Link":"http://www.sec.state.ma.us/ele/elepdf/eledaylglsum.doc"
  },
  {
    "Certified?":"No",
    "State":"MI",
    ...
    "Link":"http://www.michigan.gov/documents/sos/Notice_To_Voters_209297_7.pdf"
  },
  {
    "Certified?":"No",
    "State":"MN",
    "Who must show identification to vote?":"Only voters registering to vote on Election Day and first-time voters who did not register in person with a government official  must show ID. ",
    "What forms of voter identification are acceptable?":"Acceptable IDs include -- but are not limited to -- a valid MN driver's license; MN ID card; student photo ID (if their college has provided a student housing list to election officials); or a tribal ID that contains the voter's name, photo, signature and voting address.",
    "If a voter does not present proper identification, can s/he still vote a regular ballot?":"No. ",
    "Link":"http://www.sos.state.mn.us/index.aspx?page=204"
  },
  {
    "Certified?":"No",
    "State":"MS",
    "Who must show identification to vote?":"Only first-time voters who did not register in person with a government official and whose driver's license number or the last four digits of their social security number has not been verified and who has not submitted a copy of valid identification already may be asked to provide identification at the polls. ",
    "What forms of voter identification are acceptable?":"Acceptable IDs include -- but are not limited to -- a current and valid MS driver's license, photo ID issued by the State of Mississippi, a U.S. passport, a Federal, State or Local government employee photo ID, a student photo ID issued by a MS university, college or community college, a U.S. military ID or a tribal photo ID. ",
    "If a voter does not present proper identification, can s/he still vote a regular ballot?":"No.",
    "Link":"http://www.msvoterid.ms.gov/PDF/Outreach%20Poster%20V2%20(4).pdf"
  },
  {
    "Certified?":"No",
    "State":"MO",
    "Who must show identification to vote?":"All voters.",
    "What forms of voter identification are acceptable?":"Acceptable forms of ID include -- but are not limited to -- an ID issued by the federal government, the state of MO, or a local election authority; a student ID issued by a MO institution of higher education; a copy of a current utility bill, bank statement, paycheck, government check or other government document that contains the name and address of the voter; or a driver's license or state ID card issued by another state.",
    "If a voter does not present proper identification, can s/he still vote a regular ballot?":"Yes. If two supervising election judges (one from each major political party) attest that they know the voter, the voter will be allowed to vote a regular ballot. If a voter does not have ID and cannot be identified, the voter will be given a provisional ballot. ",
    "Link":"http://www.sos.mo.gov/elections/goVoteMissouri/docs/acceptable_ids.pdf"
  },
  {
    "Certified?":"Yes",
    "State":"MT",
  ...
  },
  {
    "Certified?":"No",
    "State":"NE",
    "Who must show identification to vote?":"First-time voters who did not provide ID with their voter registration application must show ID.",
    ...
    "If a voter does not present proper identification, can s/he still vote a regular ballot?":"No. The voter must vote a provisional ballot. ",
    "Link":"http://nebraskalegislature.gov/laws/statutes.php?statute=32-914"
  },
  {
    "Certified?":"Yes",
    "State":"NV",
    ...
    "If a voter does not present proper identification, can s/he still vote a regular ballot?":"No. The voter must vote a provisional ballot. ",
    "Link":"http://www.leg.state.nv.us/NRS/NRS-293.html#NRS293Sec2725"
  },
  {
    "Certified?":"No",
    "State":"NH",
    "Who must show identification to vote?":"All voters.",
    "What forms of voter identification are acceptable?":"Acceptable IDs include -- but are not limited to -- a driver's license issued by any state (even if expired); a valid photo ID card issued by federal, state, county or local government; a valid student ID card; a U.S. Armed Services ID card; or a U.S. Passport (even if expired).",
    "If a voter does not present proper identification, can s/he still vote a regular ballot?":"Yes. A voter without ID can execute a \"challenged voter affadavit,\" then vote a regular ballot.",
    "Link":"http://sos.nh.gov/voterid.aspx"
  },
  {
    "Certified?":"No",
    "State":"NJ",
    ...
    "Link":"http://www.state.nj.us/state/elections/voting-information-faq.html"
  },
  {
    "Certified?":"Yes",
    "State":"NM",
    ...
    "Link":"http://www.sos.state.nm.us/Voter_Information/Frequently_Asked_Questions.aspx#Voting02"
  },
  {
    "Certified?":"No",
    "State":"NY",
    ...
    "Link":"http://www.elections.ny.gov/NYSBOE/download/voting/voteform.pdf"
  },
  {
    "Certified?":"Yes",
    "State":"NC",
    ...
    "Link":"http://www.ncsbe.gov/ncsbe/Voter-Id"
  },
  {
    "Certified?":"Yes",
    "State":"ND",
    ...
    "Link":"https://vip.sos.nd.gov/pdfs/Portals/id-requirements.pdf"
  },
  {
    "Certified?":"Yes",
    "State":"OH",
    "Who must show identification to vote?":"All voters. Also applies to voters voting an absentee ballot.",
    "What forms of voter identification are acceptable?":"Acceptable IDs include -- but are not limited to -- a current and valid photo ID; a military ID; or or a copy of a current utility bill, bank statement, government check or paycheck with the voter's name and voting address. ",
    "If a voter does not present proper identification, can s/he still vote a regular ballot?":"No. The voter must vote a provisional ballot. ",
    "Link":"http://www.sos.state.oh.us/elections/Voters/FAQ/ID.aspx"
  },
  {
    "Certified?":"No",
    "State":"OK",
    "Who must show identification to vote?":"All voters.",
    "What forms of voter identification are acceptable?":"\n\nAcceptable forms of ID must have been issued by the U.S. government, the state of Oklahoma\nor a federally recognized tribal government and have the voter's name and photo and an expiration date after Election Day, unless the identification is valid indefinitely. Acceptable IDs include -- but are not limited to -- an OK driver's license or state ID card; a U.S. passport; a military ID; or the voter ID card issued by the Board of Elections.\n\n \n\n",
    ...
    "Link":"http://www.ok.gov/elections/Candidates_&_Elections/Facts_about_Proof_of_Identity_for_Voting_in_Oklahoma/"
  },
  {
    "Certified?":"Yes",
    "State":"OR",
    "Who must show identification to vote?":"No one. Voters whose identity cannot be verified using certain identifying numbers must send a copy of their ID with their registration form, not their ballot.",
    ...
    "Link":"http://www.sos.state.or.us/elections/doc/voterresources/vbm/vbm_manual.pdf"
  },
  {
    "Certified?":"Yes",
    "State":"PA",
    ...
    "If a voter does not present proper identification, can s/he still vote a regular ballot?":"Yes, as long as the voter is not voting for the first-time in that election district. For a first-time voter who are unable to present acceptable ID, then s/he must vote by provisional ballot. All other voters will be asked for ID but if they are unable to provide it, they will be able to vote by regular ballot.",
    "Link":"http://www.votespa.com/portal/server.pt?open=514&objID=1174114&parentname=ObjMgr&parentid=4&mode=2"
  },
  {
    "Certified?":"Yes-edited 11/6",
    "State":"RI",
    "Who must show identification to vote?":"All voters.",
    ...
    "Link":"http://sos.ri.gov/elections/voterid/"
  },
  {
    "Certified?":"No",
    "State":"SC",
    ...
    "Link":"http://www.scvotes.org/south_carolina_voting_information_page"
  },
  {
    "Certified?":"Yes",
    "State":"SD",
    "Who must show identification to vote?":"All voters.",
    "What forms of voter identification are acceptable?":"Acceptable IDs include -- but are not limited to -- a SD driver's license or non-driver ID card; a U.S. passport or Military photo ID; a tribal photo ID card; a current student photo ID card issued by a South Dakota high school or an accredited institution of higher education.",
    "If a voter does not present proper identification, can s/he still vote a regular ballot?":"No. The voter must vote a provisional ballot. ",
    "Link":"http://sdsos.gov/Elections/WhatAmI.aspx?pnl=firsttime"
  },
  {
    "Certified?":"Yes",
    "State":"TN",
    "Who must show identification to vote?":"All voters. Exception include: A voters who vote absentee by mail; voters who are residents in a licensed nursing home or assisted living center and vote at that facility; hospitalized voters; voters with a religious objection to being photographed; and indigent voters.",
    "What forms of voter identification are acceptable?":"Acceptable IDs include -- but are not limited to -- a TN driver's license with photo; U.S. passport; photo ID issued by the federal or state government; U.S. military photo ID; or gun permit card with photo. ",
    "If a voter does not present proper identification, can s/he still vote a regular ballot?":"No. The voter must vote a provisional ballot unless they fit into the ID exceptions.",
    "Link":"http://www.tn.gov/safety/photoids.shtml"
  },
  {
    "Certified?":"No",
    "State":"TX",
    "Who must show identification to vote?":"Any voter who doesn't present a voter registration certificate when checking in at the polling place, along with first-time voters who didn't give an identification number or ID when registering to vote must show ID.",
    "What forms of voter identification are acceptable?":"Acceptable IDs include -- but are not limited to -- a driver's license or personal ID card; a birth certificate; U.S. citizenship papers; U.S. passport; a copy of a current utility bill, bank statement, government check or paycheck with the voter's name and voting address. ",
    "If a voter does not present proper identification, can s/he still vote a regular ballot?":"Yes. The voter may present their voter registration certificate.",
    "Link":"http://www.sos.state.tx.us/elections/pamphlets/largepamp.shtml"
  },
  {
    "Certified?":"Yes",
    "State":"UT",
    ...
    "Link":"http://vote.utah.gov/vote/menu/requirements.html."
  },
  {
    "Certified?":"Yes",
    "State":"VT",
    ...
    "Link":"http://www.leg.state.vt.us/statutes/fullsection.cfm?Title=17&Chapter=051&Section=02563"
  },
  {
    "Certified?":"Yes",
    "State":"VA",
    "Who must show identification to vote?":"All voters who vote in person and some voters who vote by mail.",
    "What forms of voter identification are acceptable?":"Acceptable IDs include -- but are not limited to -- a valid VA driver's license; any federal, state or local government-issued ID; social security card; Military ID; VA voter ID card or a current utility bill, bank statement, government check or paycheck that shows the voter's name and voting address.",
    "If a voter does not present proper identification, can s/he still vote a regular ballot?":"No. The voter must vote a provisional ballot. ",
    "Link":""
  },
  {
    ...
    "Link":"http://www.sos.wa.gov/elections/voters.aspx"
  },
  {
    "Certified?":"Yes",
    "State":"WV",
    ...
    "If a voter does not present proper identification, can s/he still vote a regular ballot?":"No. The voter must then vote a provisional ballot. ",
    "Link":"http://law.justia.com/codes/west-virginia/2011/chapter03/article1/3-1-34/"
  },
  {
    "Certified?":"Yes-edited 11/6",
    "State":"WI",
  ...
  },
  {
    ...
    "If a voter does not present proper identification, can s/he still vote a regular ballot?":"No. The voter must then vote a provisional ballot. ",
    "Link":"http://soswy.state.wy.us/elections/registeringtovote.aspx"
  }
];
},{}]},{},[14])